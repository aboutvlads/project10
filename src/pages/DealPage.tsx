    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative h-[50vh] w-full">
        <button 
          ...
          className="absolute top-6 left-6 z-10 bg-white rounded-full p-2 shadow-lg hover:bg-gray-50"
        >
        ...
        />
        {deal.is_hot && (
          <div className="absolute top-6 right-6 bg-red-500 text-white px-3 py-1 rounded-full flex items-center gap-1">
        ...
        <div className="flex justify-between items-start mb-6">
          <div>
            ...
            <div className="space-y-1">
              ...
              <p className="text-gray-600">{deal.cabin_type}</p>
            </div>
          </div>
        ...
        <div className="bg-gray-50 rounded-xl p-8 mb-8">
          <div className="flex items-center justify-between">
            ...
            <div className="text-center flex-shrink-0">
              <p className="text-3xl font-bold mb-1">{deal.departure_time}</p>
              <p className="text-gray-600 text-lg">{deal.departure}</p>
            </div>
            
            {/* Flight Path */}
            <div className="flex-1 mx-12 relative flex flex-col items-center">
              {/* Duration */}
              <div className="mb-4">
                <div className="bg-white px-4 py-1.5 rounded-full shadow-sm">
                  <span className="text-sm font-medium text-gray-600">{deal.flight_duration}</span>
                </div>
              </div>
              ...
              <div className="w-full relative">
                ...
                <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-gray-50 rounded-full p-2">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 text-gray-400 transform rotate-90">
              ...
              <div className="mt-4">
                <div className="bg-white px-4 py-1.5 rounded-full shadow-sm">
                  <span className="text-sm text-gray-500">{deal.stops}</span>
                </div>
              </div>
            </div>
            ...
            {/* Arrival */}
            <div className="text-center flex-shrink-0">
              <p className="text-3xl font-bold mb-1">{deal.arrival_time}</p>
              <p className="text-gray-600 text-lg">{deal.destination}</p>
            </div>
          </div>
        </div>
